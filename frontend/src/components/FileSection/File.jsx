...
export default function File(props) {
  ...
  return (
    <div ref={fileRef}>
      <div 
      className='w-grow bg-violet-500 p-2 flex gap-2 text-white border-l-4 border-white cursor-pointer'
      onClick={handleClick}
      >
      ...
      {showOptions && <FileOptions file={fileRef} id={data._id} setState={props.setState} setShowOptions={setShowOptions}/>}
    </div>
  )
}
